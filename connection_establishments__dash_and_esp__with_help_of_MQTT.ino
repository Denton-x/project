...
// Wi-Fi credentials
// ==========================
const char* ssid = "Muhura12";
const char* password = "321@Lycee";

// ==========================
// MQTT broker settings
// ==========================
const char* mqttServer = "broker.hivemq.com";   // or your broker IP/domain
const int mqttPort = 1883;// THERE ARE KIND OF 3 PORTS, 1;1883 UNSECURED(UNENCREPTED) 2;8883:ENCREPTED 3;9001:WEBSOCKET
